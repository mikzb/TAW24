...
<body>
<h1>Editar Dieta</h1>
<form:form method="post" action="/dietista/guardarEdicionDieta" modelAttribute="dietaNueva">
...
<button onclick="window.location.href='/dietista/verDietaDietista?id=<%= dietaActual.getId() %>'">Volver</button>
</body>
</html>